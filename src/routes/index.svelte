...
<About id="read-more">
  ...
  <p class="about-description">
    Profit-Sharing Tokens, or PSTs, are a new incentivization mechanism for the open web that allow developers to earn a stream of micro-dividends for the duration their application is used. (<a href="https://medium.com/@arweave/profit-sharing-tokens-a-new-incentivization-mechanism-for-an-open-web-1f2532411d6e">Source</a>)
  </p>
  <p class="about-description">
...
<About>
  ...
  <p class="about-desciption">
    You can also easily host your own Trading Post, while accruing PSTs for doing so. See our <a href="https://github.com/useverto/trading-post">Trading Post Repository</a> for documentation.
  </p>
</About>
<About>
